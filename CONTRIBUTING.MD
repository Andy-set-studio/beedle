...
1. Make sure that tests are passing
2. Make sure that your work matches the code style of the rest of the repository
3. Make sure that your work is clearly commented
4. Make sure that any documentation is updated
